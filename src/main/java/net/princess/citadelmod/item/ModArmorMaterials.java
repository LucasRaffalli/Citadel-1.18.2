...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ZORIUM("zorium", 37, new int[]{6, 8, 13, 6}, 25, SoundEvents.ARMOR_EQUIP_NETHERITE, 5.0F, 1F, () -> {
        return Ingredient.of(ModItems.BURNING_RAW_ZORIUM.get());
    });
    ...
    public String getName() {
        return CitadelMod.MOD_ID + ":" +this.name;
    }
